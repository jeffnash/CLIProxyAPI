...
const (
	...
	// provider — e.g. cursor-grok-4.6 vs xAI's grok-4.6. handlers.go strips the prefix
	// and sets forced_provider=true; the bridge receives the bare SDK id (grok-4.6).
