...
// sanitizeAntigravityClaudeGeminiRequestSignatures preserves the historical
// unexported entry point and delegates to SanitizeAntigravityClaudeGeminiRequestSignatures.
