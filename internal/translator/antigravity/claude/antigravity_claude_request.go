...
func ConvertClaudeRequestToAntigravity(modelName string, inputRawJSON []byte, _ bool) []byte {
	...
	// Map Anthropic thinking -> Gemini thinkingBudget/thinkingLevel. Thinking
	// amount and summary visibility are independent: includeThoughts is written
	// only for an explicit summary selector (handled by the thinking pipeline),
	// never as a default alongside the amount.
